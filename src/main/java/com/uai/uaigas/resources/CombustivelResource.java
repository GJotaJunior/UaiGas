...
public class CombustivelResource {
	...
	@PostMapping
	public ResponseEntity<CombustivelDTO> insert(@RequestBody CombustivelDTO dto) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<CombustivelDTO> update(@PathVariable Long id, @RequestBody CombustivelDTO dto) {
